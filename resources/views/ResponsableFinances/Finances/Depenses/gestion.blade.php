    ...
    <div class="card">
        <div class="card-header">
            <h2>
                ...
                <a href="{{route('responsablefinances.depenses.index')}}" style="float: right;" class="btn btn-sm btn-info ml-2"><i class="fa fa-arrow-left"></i> RETOUR</a>
            ...
            <table class="table table-sm table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('responsablefinances.depenses.show', $depense->token)}}">{{$depense->name}}</a></td>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
          <form action="{{route('responsablefinances.depenses.store')}}" method="post">
              @csrf
              <div class="card-header">
