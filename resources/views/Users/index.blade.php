            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="/users/store">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right"> Confirmer le mot de pass </label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" name="role_id" class="col-md-4 col-form-label text-md-right"> Role </label>
