		...
		<div class="wizard-v10-content mt-5">
			<div class="wizard-form">
		        ...
		        <form class="form-register" action="{{route('adminecole.profs.store')}}" method="post">
			                ...
			                <div class="inner">
								<div class="form-row">
									<div class="form-holder">
										<label for="">Nom</label>
										<input type="text" class="form-control nom" id="name" name="name">
									</div>
									<div class="form-holder form-holder-2">
										<label for="">Numéro de téléphone</label>
										<input type="number" class="form-control telephone" id="phone" name="phone">
									</div>
								</div>
								<div class="form-row">
									<div class="form-holder">
					...
					<button class="btn btn-default btn-save">Suivant</button>
		        </form>
			</div>
		</div>
	</div>
