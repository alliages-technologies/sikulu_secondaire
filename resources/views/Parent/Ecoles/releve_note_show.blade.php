...
<div class="container">
    @if ($premier_mois == null)
        ...
        @if ($paye_mois_en_cours == null)
            <marquee behavior="" direction=""> <span style="color: red;font-size: 35px;text-align: center;"> Vous ne pouvez pas voir le relevé de votre enfant car vous n'êtes pas à jours, veuillez vous rapprocher de l'école pour effectuer le paiement. Merci !!! </span></marquee>
        @else
