...
<h4 class="text-center mt-4" style="letter-spacing: 2px">Notes /> Salles</h4>
    ...
    <table class="table table-striped table-bordered table-sm mt-4  ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="/profs/notes-by-inscription/{{ $ligne_programme_ecole->programmeecole->salle->token }}/{{ $ligne_programme_ecole->id }}" class="btn btn-default btn-xs col-md-3 m-2"><i class="fa fa-eye"></i></a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
