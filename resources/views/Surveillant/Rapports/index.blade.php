            ...
            <table class="table table-striped table-bordered table-sm mt-4  ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> {{ $rapport_cour->pel->enseignant->name }} </td>
                        <td> <a href="/surveillant/rapport-ecole-show/{{$rapport_cour->ecole->token}}/{{$rapport_cour->id}}" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></a> </td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
